...
import (
	...
	extensionlister "k8s.io/client-go/listers/extensions/v1beta1"
	"k8s.io/client-go/tools/cache"
	"k8s.io/client-go/tools/record"
	"k8s.io/client-go/util/workqueue"

	samplev1alpha1 "github.com/a8uhnf/test-crd/pkg/apis/samplecontroller/v1alpha1"
	clientset "github.com/a8uhnf/test-crd/pkg/client/clientset/versioned"
	samplescheme "github.com/a8uhnf/test-crd/pkg/client/clientset/versioned/scheme"
	informers "github.com/a8uhnf/test-crd/pkg/client/informers/externalversions"
	listers "github.com/a8uhnf/test-crd/pkg/client/listers/samplecontroller/v1alpha1"
)
...
type Controller struct {
	...
	deploymentsLister extensionlister.DeploymentLister
...
func NewController(
	...
	deploymentInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(old, new interface{}) {
			newDepl := new.(*extensionv1beta1.Deployment)
			oldDepl := old.(*extensionv1beta1.Deployment)
...
func (c *Controller) updateFooStatus(foo *samplev1alpha1.Foo, deployment *extensionv1beta1.Deployment) error {
...
func newDeployment(foo *samplev1alpha1.Foo) *extensionv1beta1.Deployment {
	...
	return &extensionv1beta1.Deployment{
		...
		Spec: extensionv1beta1.DeploymentSpec{
